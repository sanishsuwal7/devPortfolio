...
import Table, { H1 } from "./blog/react-cheatsheet/components/table-of-contents-q"
...
**THE DOM**
![image of the real DOM ](/blog/react-cheatsheet/DOM.png)

**THE VIRTUAL DOM**
![image of the virtual DOM ](/blog/react-cheatsheet/VDOM.png)
...
- A component gets initialized, mounted, updated and unmounted. These methods live under the useEffect hook.
  ![lifecycle methods diagram](/blog/react-cheatsheet/lifecycle.png)
...
<H1>What are controlled and uncontrolled components?</H1>
